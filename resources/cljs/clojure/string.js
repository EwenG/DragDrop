...
{{
var G__24268 = cljs.core.pop.call(null,v__$1);
v__$1 = G__24268;
continue;
}
} else
...
{var pred__24272 = cljs.core._EQ_;var expr__24273 = limit;if(cljs.core.truth_(pred__24272.call(null,1,expr__24273)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__24272.call(null,2,expr__24273)))
...
var G__24275 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__24276 = (limit__$1 - 1);
var G__24277 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__24275;
limit__$1 = G__24276;
parts = G__24277;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___24279 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___24279))
{var replacement_24280 = temp__4090__auto___24279;buffer.append([cljs.core.str(replacement_24280)].join(''));
} else
{buffer.append(ch);
}
{
var G__24281 = (index + 1);
index = G__24281;
continue;
}
}
