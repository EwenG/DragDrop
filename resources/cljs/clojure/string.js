...
{{
var G__30206 = cljs.core.pop.call(null,v__$1);
v__$1 = G__30206;
continue;
}
} else
...
{var pred__30210 = cljs.core._EQ_;var expr__30211 = limit;if(cljs.core.truth_(pred__30210.call(null,1,expr__30211)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__30210.call(null,2,expr__30211)))
...
var G__30213 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__30214 = (limit__$1 - 1);
var G__30215 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__30213;
limit__$1 = G__30214;
parts = G__30215;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___30217 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___30217))
{var replacement_30218 = temp__4090__auto___30217;buffer.append([cljs.core.str(replacement_30218)].join(''));
} else
{buffer.append(ch);
}
{
var G__30219 = (index + 1);
index = G__30219;
continue;
}
}
