...
{{
var G__159092 = cljs.core.pop.call(null,v__$1);
v__$1 = G__159092;
continue;
}
} else
...
{var pred__159096 = cljs.core._EQ_;var expr__159097 = limit;if(cljs.core.truth_(pred__159096.call(null,1,expr__159097)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__159096.call(null,2,expr__159097)))
...
var G__159099 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__159100 = (limit__$1 - 1);
var G__159101 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__159099;
limit__$1 = G__159100;
parts = G__159101;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___159103 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___159103))
{var replacement_159104 = temp__4090__auto___159103;buffer.append([cljs.core.str(replacement_159104)].join(''));
} else
{buffer.append(ch);
}
{
var G__159105 = (index + 1);
index = G__159105;
continue;
}
}
