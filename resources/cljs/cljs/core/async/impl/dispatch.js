...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_23987 = 0;while(true){
var m_23988 = cljs.core.async.impl.dispatch.tasks.pop();if((m_23988 == null))
{} else
{m_23988.call(null);
if((count_23987 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__23989 = (count_23987 + 1);
count_23987 = G__23989;
continue;
}
} else
{}
