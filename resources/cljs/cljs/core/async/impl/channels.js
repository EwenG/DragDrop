...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t158817 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t158817 = (function (val,box,meta158818){
this.val = val;
this.box = box;
this.meta158818 = meta158818;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t158817.cljs$lang$type = true;
cljs.core.async.impl.channels.t158817.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t158817";
cljs.core.async.impl.channels.t158817.cljs$lang$ctorPrWriter = (function (this__3970__auto__,writer__3971__auto__,opt__3972__auto__){return cljs.core._write.call(null,writer__3971__auto__,"cljs.core.async.impl.channels/t158817");
});
cljs.core.async.impl.channels.t158817.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t158817.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_158819){var self__ = this;
var _158819__$1 = this;return self__.meta158818;
});
cljs.core.async.impl.channels.t158817.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_158819,meta158818__$1){var self__ = this;
var _158819__$1 = this;return (new cljs.core.async.impl.channels.t158817(self__.val,self__.box,meta158818__$1));
});
cljs.core.async.impl.channels.__GT_t158817 = (function __GT_t158817(val__$1,box__$1,meta158818){return (new cljs.core.async.impl.channels.t158817(val__$1,box__$1,meta158818));
});
}
return (new cljs.core.async.impl.channels.t158817(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_158820 = self__.takes.pop();if((taker_158820 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_158820))
{var take_cb_158821 = cljs.core.async.impl.protocols.commit.call(null,taker_158820);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_158821,taker_158820){
return (function (){return take_cb_158821.call(null,null);
});})(take_cb_158821,taker_158820))
);
} else
{}
{
