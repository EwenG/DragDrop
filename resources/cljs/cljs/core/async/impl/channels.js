...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t23993 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t23993 = (function (val,box,meta23994){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t23993.cljs$lang$type = true;
cljs.core.async.impl.channels.t23993.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t23993";
cljs.core.async.impl.channels.t23993.cljs$lang$ctorPrWriter = (function (this__3970__auto__,writer__3971__auto__,opt__3972__auto__){return cljs.core._write.call(null,writer__3971__auto__,"cljs.core.async.impl.channels/t23993");
});
cljs.core.async.impl.channels.t23993.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t23993.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23995){var self__ = this;
var _23995__$1 = this;return self__.meta23994;
});
cljs.core.async.impl.channels.t23993.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23995,meta23994__$1){var self__ = this;
var _23995__$1 = this;return (new cljs.core.async.impl.channels.t23993(self__.val,self__.box,meta23994__$1));
});
cljs.core.async.impl.channels.__GT_t23993 = (function __GT_t23993(val__$1,box__$1,meta23994){return (new cljs.core.async.impl.channels.t23993(val__$1,box__$1,meta23994));
});
}
return (new cljs.core.async.impl.channels.t23993(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_23996 = self__.takes.pop();if((taker_23996 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_23996))
{var take_cb_23997 = cljs.core.async.impl.protocols.commit.call(null,taker_23996);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_23997,taker_23996){
return (function (){return take_cb_23997.call(null,null);
});})(take_cb_23997,taker_23996))
);
} else
{}
{
