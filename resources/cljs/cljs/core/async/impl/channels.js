...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t29931 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t29931 = (function (val,box,meta29932){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t29931.cljs$lang$type = true;
cljs.core.async.impl.channels.t29931.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t29931";
cljs.core.async.impl.channels.t29931.cljs$lang$ctorPrWriter = (function (this__4024__auto__,writer__4025__auto__,opt__4026__auto__){return cljs.core._write.call(null,writer__4025__auto__,"cljs.core.async.impl.channels/t29931");
});
cljs.core.async.impl.channels.t29931.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t29931.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_29933){var self__ = this;
var _29933__$1 = this;return self__.meta29932;
});
cljs.core.async.impl.channels.t29931.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_29933,meta29932__$1){var self__ = this;
var _29933__$1 = this;return (new cljs.core.async.impl.channels.t29931(self__.val,self__.box,meta29932__$1));
});
cljs.core.async.impl.channels.__GT_t29931 = (function __GT_t29931(val__$1,box__$1,meta29932){return (new cljs.core.async.impl.channels.t29931(val__$1,box__$1,meta29932));
});
}
return (new cljs.core.async.impl.channels.t29931(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__4027__auto__,writer__4028__auto__,opts__4029__auto__){return cljs.core._write.call(null,writer__4028__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__4024__auto__,writer__4025__auto__,opt__4026__auto__){return cljs.core._write.call(null,writer__4025__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_29934 = self__.takes.pop();if((taker_29934 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_29934))
{var take_cb_29935 = cljs.core.async.impl.protocols.commit.call(null,taker_29934);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_29935,taker_29934){
return (function (){return take_cb_29935.call(null,null);
});})(take_cb_29935,taker_29934))
);
} else
{}
{
